...
void OvrMobileController::update_controller_vibration(ovrMobile *ovr,
    ...
    if (!controller_state.connected ||
        controller_state.godot_controller_id == kInvalidGodotControllerId) {
        return;
    }
    ...
    const float intensity =
            godot::arvr_api->godot_arvr_get_controller_rumble(controller_state.godot_controller_id);
    vibrate_controller(
            controller_state.godot_controller_id, kControllerRumbleDurationInMs, intensity);
    ...
    if (vibration.is_vibrating &&
        ...
        vrapi_SetHapticVibrationSimple(
                ovr, controller_state.remote_capabilities.Header.DeviceID, 0.0f);
    ...
    if (vibration.end_time_in_ms > 0) {
        vrapi_SetHapticVibrationSimple(
                ovr, controller_state.remote_capabilities.Header.DeviceID, vibration.intensity);
...
void OvrMobileController::update_controller_input_state_tracked_remote(
        ovrMobile *ovr,
        ControllerState &controller_state) {
    ...
    if (has_joystick(controller_state.remote_capabilities)) {
        // X axis
        godot::arvr_api->godot_arvr_set_controller_axis(controller_state.godot_controller_id,
                                                        kXAxis,
                                                        input_state.Joystick.x,
                                                        true /* can_be_negative */);
        // Y axis
        godot::arvr_api->godot_arvr_set_controller_axis(controller_state.godot_controller_id,
                                                        kYAxis,
                                                        input_state.Joystick.y,
                                                        true /* can_be_negative */);
    }

    if (has_trackpad(controller_state.remote_capabilities)) {
        // X axis
        float positionX = input_state.TrackpadStatus ?
                                  input_state.TrackpadPosition.x /
        ...
        // Y axis
        float positionY = input_state.TrackpadStatus ?
                                  input_state.TrackpadPosition.y /
    ...
    if (has_analog_grip_trigger(controller_state.remote_capabilities)) {
        godot::arvr_api->godot_arvr_set_controller_axis(controller_state.godot_controller_id,
                                                        ...
                                                        input_state.GripTrigger,
                                                        false /* can_be_negative */);
    }

    // Update the controller button state. The button mappings for Godot will differ based on the
    ...
    if (is_oculus_touch_controller(controller_state.remote_capabilities)) {
        ...
        godot::arvr_api->godot_arvr_set_controller_button(controller_state.godot_controller_id,
                                                          2,
                                                          input_state.GripTrigger >
                                                                  kGripTriggerPressedThreshold);
        godot::arvr_api->godot_arvr_set_controller_button(
                controller_state.godot_controller_id,
                10,
                check_bit(input_state.Touches, ovrTouch_ThumbUp));
        godot::arvr_api->godot_arvr_set_controller_button(
                controller_state.godot_controller_id,
                11,
                check_bit(input_state.Touches, ovrTouch_IndexTrigger));
        godot::arvr_api->godot_arvr_set_controller_button(
                controller_state.godot_controller_id,
                12,
                check_bit(input_state.Touches, ovrTouch_IndexPointing));
        godot::arvr_api->godot_arvr_set_controller_button(controller_state.godot_controller_id,
                                                          15,
                                                          input_state.IndexTrigger >
        ...
        if (is_left_touch_controller(controller_state.remote_capabilities)) {
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    3,
                    check_bit(input_state.Buttons, ovrButton_Enter)); // menu button
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    14,
                    check_bit(input_state.Buttons, ovrButton_LThumb));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    7,
                    check_bit(input_state.Buttons, ovrButton_X));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    5,
                    check_bit(input_state.Touches, ovrTouch_X));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    1,
                    check_bit(input_state.Buttons, ovrButton_Y));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    6,
                    check_bit(input_state.Touches, ovrTouch_Y));
        }
        ...
        if (is_right_touch_controller(controller_state.remote_capabilities)) {
            ...
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    7,
                    check_bit(input_state.Buttons, ovrButton_A));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    5,
                    check_bit(input_state.Touches, ovrTouch_A));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    1,
                    check_bit(input_state.Buttons, ovrButton_B));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    6,
                    check_bit(input_state.Touches, ovrTouch_B));
            godot::arvr_api->godot_arvr_set_controller_button(
                    controller_state.godot_controller_id,
                    14,
...
void OvrMobileController::update_controller_input_state_hand(ovrMobile *ovr,
    ...
    godot::arvr_api->godot_arvr_set_controller_button(
            controller_state.godot_controller_id,
            7,
            check_bit(input_state.InputStateStatus, ovrInputStateHandStatus_IndexPinching));
    godot::arvr_api->godot_arvr_set_controller_button(
            controller_state.godot_controller_id,
            1,
            check_bit(input_state.InputStateStatus, ovrInputStateHandStatus_MiddlePinching));

    // pinch ring and pinky are mapped to grip (2) and index (15) triggers for now
    godot::arvr_api->godot_arvr_set_controller_button(
            controller_state.godot_controller_id,
            2,
            check_bit(input_state.InputStateStatus, ovrInputStateHandStatus_RingPinching));
    godot::arvr_api->godot_arvr_set_controller_button(
            controller_state.godot_controller_id,
            15,
            check_bit(input_state.InputStateStatus, ovrInputStateHandStatus_PinkyPinching));

    // to allow accessing the pinch state as provided by the API we map them here to the joystick
    // axis of the controller this will give the ability to access the basic hand tracking gestures
...
void OvrMobileController::update_controller_tracking_state(ovrMobile *ovr,
    ...
    if (controller_state.capability_header.Type == ovrControllerType_TrackedRemote) {
        update_controller_tracking_state_tracked_remote(
                ovr, controller_state, predicted_display_time);
    } else if (controller_state.capability_header.Type == ovrControllerType_Hand) {
...
void OvrMobileController::update_controller_tracking_state_tracked_remote(
        ovrMobile *ovr,
        ControllerState &controller_state,
        double predicted_display_time) {
    // Tracked remote is connected. Get the device tracking state.
    if (vrapi_GetInputTrackingState(ovr,
                                    controller_state.remote_capabilities.Header.DeviceID,
                                    predicted_display_time,
                                    &controller_state.tracking_state) < 0) {
        return;
    }
    ...
    godot_transform_from_ovr_pose(
            &transform,
            controller_state.tracking_state.HeadPose.Pose,
            1.0); // worldscale is already applied in godot_arvr_set_controller_transform
    godot::arvr_api->godot_arvr_set_controller_transform(
            controller_state.godot_controller_id,
            &transform,
...
void OvrMobileController::update_controller_tracking_state_hand(ovrMobile *ovr,
                                                                ControllerState &controller_state,
                                                                double predicted_display_time) {
    if (vrapi_GetInputTrackingState(ovr,
                                    controller_state.capability_header.DeviceID,
                                    predicted_display_time,
                                    &controller_state.tracking_state) < 0) {
        return;
    }
    ...
    vrapi_GetHandPose(ovr,
                      controller_state.capability_header.DeviceID,
                      predicted_display_time,
                      &controller_state.hand_pose.Header);

    // Update the controller transform.
    godot_transform transform;
    // godot_transform_from_ovr_pose(&transform, controller_state.tracking_state.HeadPose.Pose,
    // godot::arvr_api->godot_arvr_get_worldscale());
    godot_transform_from_ovr_pose(
            &transform,
            controller_state.hand_pose.RootPose,
            1.0); // worldscale is already applied in godot_arvr_set_controller_transform
    godot::arvr_api->godot_arvr_set_controller_transform(
            controller_state.godot_controller_id, &transform, true, true);
}
    ...
    for (uint32_t device_index = 0;
        ...
        if (capability_header.Type == ovrControllerType_TrackedRemote) {
            ...
            if (is_oculus_touch_controller(tracked_remote_capabilities)) {
                ...
                // We're handling a Gear VR or Oculus Go controller. Let's query the user dominant
                // hand to find out where to assign the controller.
                auto dominant_hand = static_cast<ovrHandedness>(
                        vrapi_GetSystemPropertyInt(java, VRAPI_SYS_PROP_DOMINANT_HAND));
            ...
            if (controllers[handedness].capability_header.Type != ovrControllerType_TrackedRemote &&
                controllers[handedness].godot_controller_id != kInvalidGodotControllerId) {
                godot::arvr_api->godot_arvr_remove_controller(
                        controllers[handedness].godot_controller_id);
                ALOGV("Removed Controller Tracked Remote (Godot id %d)",
                      controllers[handedness].godot_controller_id);
                controllers[handedness].godot_controller_id = kInvalidGodotControllerId;
            }
            ...
            // this check forces a reconnect below because the type of the controller changed
            if (controllers[handedness].capability_header.Type != ovrControllerType_Hand &&
                controllers[handedness].godot_controller_id != kInvalidGodotControllerId) {
                godot::arvr_api->godot_arvr_remove_controller(
                        controllers[handedness].godot_controller_id);
                ALOGV("Removed Tracked Hand (Godot id %d)",
                      controllers[handedness].godot_controller_id);
                controllers[handedness].godot_controller_id = kInvalidGodotControllerId;
            }
            controllers[handedness].connected = true;
